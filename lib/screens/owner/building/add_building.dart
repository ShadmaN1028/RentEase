    ...
    try {
      ...
      final response = await apiService.dio.post(
        ...
        data: {
          ...
          'parking': int.parse(_parkingController.text.trim()),
        },
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Parking Available (1 for Yes, 0 for No)',
                  prefixIcon: Icon(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return 'Please enter parking availability';
                  }
                  return null;
                },
              ),
