...
const queries = {
  ...
  updateInfo: `UPDATE ${table_name} SET first_name = ?, last_name = ?, nid = ?, permanent_address = ?, contact_number = ?, occupation = ?, last_update_date = CURRENT_TIMESTAMP(), change_number = change_number + 1 WHERE user_id = ?`,
